...
class TimeStretch(nn.Module):
    def __init__(self, p=0.2, min_stretch=0.95, max_stretch=1.05, n_freq=128, *args, **kwargs):
        super().__init__()
        self.p = p
    ...
    def __call__(self, data: Tensor):
        ...
        stretch = np.random.random() * (self.max_stretch - self.min_stretch) + self.min_stretch
