    ...
    def __init__(self, alphabet=None, lm_decoding=False, use_bpe_tokenizer=False, bpe_model_path=None, **kwargs):
        ...
        Args:
            alphabet (list): alphabet for language. If None, it will be
                set to ascii
            lm_decoding (bool): use LM model with torchaudio beam_search for decoding
            use_bpe_tokenizer (bool): use vocabulary from pretrained bpe model instead of just characters
            bpe_model_path (str): path to pretrained bpe model (required if use_bpe_tokenizer is True)
        """
